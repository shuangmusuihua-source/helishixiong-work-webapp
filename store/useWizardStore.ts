...
interface WizardState {
  ...
  setAesthetic: (aesthetic: string | null) => void;
  setPageCount: (count: number | null) => void;
  setTextDensity: (density: TextDensity | null) => void;
  setMotionLevel: (level: MotionLevel | null) => void;
  setGeneratedComponents: (code: string | null) => void;
  setDesign: (design: DesignSystem | null) => void;
